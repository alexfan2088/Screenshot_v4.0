...
namespace Screenshot.Core
{
    ...
    public class RecordingConfig
    {
        ...
        public AudioCaptureMode AudioCaptureMode { get; set; } = AudioCaptureMode.NativeSystemAudio;
        ...
        public CaptureMode CaptureMode { get; set; } = CaptureMode.AnyRegion;
        ...
        public double EstimateFileSizePerMinute(int outputWidth = 0, int outputHeight = 0)
        {
            ...
            return (videoBitrateMbps + audioBitrateMbps) * 60.0 / 8.0;
        }
